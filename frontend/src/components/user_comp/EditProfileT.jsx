...
const EditProfileT = ({ data = amptyUser }) => {
  ...
  //   const username = Auth.nom[0] + "_" + Auth.prénom;
      ...
      <div className="bg-white flex flex-wrap gap-3 p-2 sm:pl-8 sm:justify-center ">
        <div className="w-[45%] max-w-[300px] ">
          <LabeledInput
            ...
            type="email"
            onChange={(value) => handleInputChange("phone_num", value)}
          />
        </div>
        <div className="w-[45%] max-w-[300px] ">
          <LabeledInput
        ...
        <div className="w-[45%]  min-h-[93px] pt-9 pr-4 max-w-[300px] h-12  mb-4 outline-none  ">
          {" "}
          <h1
            onClick={() => {
          ...
          onClick={() => {
            if (ableToSubmit) {
              ...
              formData?.email === ""
                ...
                : formData?.phone_num.length < 6
                ? setAnError("Phone number should be valid ! (6 digits)")
...
export default memo(EditProfileT);
