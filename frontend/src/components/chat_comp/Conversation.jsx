...
const Conversation = ({data}) => {
  return (
    <div className=" cursor-pointer hover:bg-bgpurp p-3  md:border-b-[2px] flex gap-2 py-4 justify-between  w-full">
      {data.pfp ? (
        <img src={data.pfp} alt="" />
      ) : (
        <div className="w-[45px] h-[45px] bg-primarypurp rounded-full"></div>
      )}
      ...
      <div className=" flex-col items-end gap-[9px] hidden sm:flex">
        <p className="text-[#A098AE] text-[12px] font-[400]">{data.messageDate}</p>
